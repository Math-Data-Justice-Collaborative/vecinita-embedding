...
class QueryRequest(BaseModel):
    ...
    model: str | None = Field(
        default=None,
        description="Optional embedding model name. Defaults to the server's configured model.",
    )
...
class EmbeddingResponse(BaseModel):
    ...
    dimensions: int = Field(..., description="The number of dimensions in the embedding.")
...
class BatchEmbeddingResponse(BaseModel):
    ...
    dimensions: int = Field(..., description="The number of dimensions in each embedding.")
